            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">{{ $blog_details->blog_title }}</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> {{ $blog_details->blog_title }} </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="standard__blog__post">
                        ...
                        <div class="blog__details__content services__details__content">
                            <ul class="blog__post__meta">
                                <li><i class="fal fa-calendar-alt"></i> {{ $blog_details->created_at->diffForHumans() }}</li>
                        ...
                        <div class="blog__details__bottom">
                            <ul class="blog__details__tag">
                                ...
                                <li class="tags-list">
                                    ...
                                    <a href="#"> {{ $blog_details->blog_tags }}</a>
                            ...
                            <ul class="rc__post">
                                ...
                                <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="{{ route('blog.detail', $blogs->id) }}"><img src="{{ asset($blogs->blog_image) }}" alt=""></a>
                                    </div>
                                    <div class="rc__post__content">
                                        <h5 class="title"><a href="{{ route('blog.detail', $blogs->id) }}"> {{ $blogs->blog_title }} </a></h5>
                                        <span class="post-date"><i class="fal fa-calendar-alt"></i> {{ $blogs->created_at->diffForHumans() }} </span>
                                    </div>
                                </li>
                                @endforeach          
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__cat">
                                @foreach($categories as $cats)
                                    <li class="sidebar__cat__item"><a href="{{ route('blog.category', $cats->id) }}"> {{ $cats-> blog_category }}</a></li> 
                                @endforeach                               
                            </ul>
                        </div>
