...
<!-- about-area -->
@include('frontend.home_about_all.home_about')
<!-- about-area-end -->
            ...
            <div class="col-xl-3">
                <div class="services__item">
                    ...
                    <div class="services__content">
                        ...
                        <p>Strategy is a forward-looking plan for your bran's behavior. Strategy is a forward-looking plan.</p>
...
<!-- portfolio-area -->
@include('frontend.home_portfolio.portfolio')
<!-- portfolio-area-end -->
...
<!-- blog-area -->
@include('frontend.home_blog.blog')
<!-- blog-area-end -->
